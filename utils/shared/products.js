const products = [
  {
    ...
    image: [
      "https://res.cloudinary.com/dmhgigndy/image/upload/v1758576440/product/csm_Apple_iPhone_17_Pro68_f1aba38de2.jpg",
      "https://res.cloudinary.com/dmhgigndy/image/upload/v1758576423/product/images%281%29.jpg",
      "https://res.cloudinary.com/dmhgigndy/image/upload/v1758576455/product/gettyimages-2233943827.jpg",
      "https://res.cloudinary.com/dmhgigndy/image/upload/v1758576446/product/iphone750_FZ.jpg",
      "https://res.cloudinary.com/dmhgigndy/image/upload/v1758576432/product/images.jpg",
    ],
    tag: ['["iPhone"]'],
    variants: [
      {
    ...
    description: {
      en: "The iPhone 17 is a premium smartphone that blends elegant design with next-generation technology. It features a sleek all-screen body, an advanced multi-lens camera system, and powerful performance tailored for both everyday use and professional tasks. With its long-lasting battery, secure ecosystem, and refined user experience, the iPhone 17 represents Apple’s latest step in combining style and innovation.",
      es: "El iPhone 17 es un smartphone de gama alta que combina un diseño elegante con tecnología de última generación. Presenta un cuerpo todo pantalla, un avanzado sistema de cámaras múltiples y un rendimiento potente, pensado tanto para el uso diario como para tareas profesionales. Con su batería de larga duración, ecosistema seguro y experiencia de usuario refinada, el iPhone 17 representa el más reciente avance de Apple en unir estilo e innovación.",
    },
    slug: "iPhone 17",
    category: {
      _id: "632ab2b64d87ff2494210aa7",
